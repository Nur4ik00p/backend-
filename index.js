...
mongoose.connect('mongodb+srv://dmitry:dmitrykhorov2009@cluster0.rmyvs.mongodb.net/chat?retryWrites=true&w=majority&appName=Cluster0', {
  retryWrites: true,
  w: 'majority'
})
.then(async () => {
...
app.post('/users/request-verification', 
  checkAuth, 
